...
## تحديث الواجهة الأخير
- فصل الديون عن جدول وإجمالي المصروفات.
- إعادة مربعات الاختيار المباشرة للأعمدة المنطقية في الجداول المخصصة، ومنها جدول الماء.
- وضع تقويم الشفتات مكان مخطط دخل مرن في الصفحة الرئيسية.
- عرض جميع التواريخ بالتقويم الميلادي.

## تحديث v5
- إضافة قاعدة جديدة للجداول المخصصة: إذا تحقق الشرط، يُخصم مبلغ الصف من المبلغ الأساسي؛ وإذا لم يتحقق فلا يتغير الناتج.
